...
public class BookMenu {
	...
	public void displayMenu() {
		...
		do {
			...
			case 4 :bcontroll.searchBook(inputBookId()); 
						break;
			case 5 :bcontroll.searchBookList(inputTitle()); 
						break;
			case 6 :bcontroll.searchBookMap(inputTitle()); 
						break;
			case 7 :bcontroll.selectAllList();
						break;
			case 8 :bcontroll.selectAllMap(); 
						break;
			case 9 : System.out.println("정말로 종료하시겠습니다?[y/n] :");
	...
	public void printMap(HashMap<Integer, Book> bookMap) {
		...
		while(keyIter.hasNext()) {
			System.out.println(keyIter.next() + " " + bookMap.get(keyIter.next()));
		}
	}
}
