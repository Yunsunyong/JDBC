...
public class EmployeeMenu {
	...
	public void displayMenu() {
		...
		do {
			...
			switch (no) {
			case 1: printList(econtroll.selectAll()); break;
			case 2: printListEmployee(econtroll.selectEmployee(inputEmpId())); break;
