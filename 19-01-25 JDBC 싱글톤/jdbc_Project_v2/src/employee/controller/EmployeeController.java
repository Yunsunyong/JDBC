...
public class EmployeeController {
	...
	public ArrayList<Employee> selectAll() {
		ArrayList<Employee> empList = edservice.selectList();
	...
	public Employee selectEmployee(String empId) {
		Employee emp = edservice.selectOne(empId);
	...
	public ArrayList<Employee> selectJobId(String jobId) {
		ArrayList<Employee> empList = edservice.selectJobList(jobId);
	...
	public ArrayList<Employee> selectDeptId(String DeptId) {
		ArrayList<Employee> empList = edservice.selectDeptId(DeptId);
