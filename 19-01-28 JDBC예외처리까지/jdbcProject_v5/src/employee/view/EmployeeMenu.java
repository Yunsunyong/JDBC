...
public class EmployeeMenu {
	...
	public void displayMenu() {
		...
		do {
			...
			switch (no) {
			case 1: printMap(econtroll.selectAll()); break;
			case 2: printMapEmployee(econtroll.selectEmployee(inputEmpId())); break;
			case 3: printMap(econtroll.selectJobId(inputJobId())); break;
			case 4: printMap(econtroll.selectDeptId(inputDeptId())); break;
